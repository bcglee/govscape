...
def main():
    ...
    whoosh_directory = args.data_directory + '/whoosh'
    index_config = gs.IndexConfig(pdf_directory, embeddings_directory, index_directory, image_directory, whoosh_directory)
    server_config = gs.ServerConfig(index_config, gs.PDFsToEmbeddings(pdf_directory, txt_directory, embeddings_directory, image_directory, whoosh_directory, gs.CLIPEmbeddingModel()))
